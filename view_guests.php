...
function getListofGuest ($db,$start,$noOfRecords,$sortby,$orderby){     
        $query = " select guest_id, guest_first_name,guest_last_name, date_format(guest_date_of_birth,'%d-%m-%Y') dob, Guest_gender from guests
...
//Page Header
echo '<h1 style="margin-left:30px;">Guest Directory</h1>';
