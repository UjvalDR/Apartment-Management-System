...
function getListofFacilities ($db,$apt_id){     
        $query = " select aa.apt_number,
				a.facility_description 
				from apartments aa,
				apartment_facilities a
				where aa.apt_id = a.apt_id and  a.apt_id=$apt_id order by a.facility_description asc ";
