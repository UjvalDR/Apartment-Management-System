...
<p>Last Name : &ensp;&ensp;&nbsp;<input type="text" name="guest_last_name" size="10" maxlength="50" value="'.$guest_last_name.'" class="textbox"/></p>
<p>Date of Birth :&ensp; <input type="date" name="guest_date_of_birth" min="1997-01-01" max="2030-12-31" size="10" maxlength="10" value="'.$guest_date_of_birth.'" class="textbox"/></p>
<p>Gender :&emsp;&emsp;&emsp; <input type="text" name="guest_gender" size="10" maxlength="1" value="'.$guest_gender.'" class="textbox"/><label>  (M/F)</label></p>
