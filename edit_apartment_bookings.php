...
echo '</p>
<p>Guest:&emsp;&emsp;&emsp; ';
getGuest($dbc,$guest_id);
 echo '</p>
<p>Booking Status :&emsp;&emsp; ';
getBookingStatus($dbc,$booking_status_code);
 echo '</p>
<p>Booking Start Date : <input type="date" name="start_date" min="1997-01-01" max="2030-12-31" size="10" maxlength="10" value="'.$start_date.'" /></p>
<p>Booking End Date :&ensp; <input type="date" name="end_date" min="1997-01-01" max="2030-12-31" size="10" maxlength="10" value="'.$end_date.'" /></p>
