...
getAptType($dbc,$apt_type);
 echo '</p>
<p>Apartment Number : &emsp;&nbsp;<input type="text" name="apt_number" size="10" maxlength="10" value="'.$apt_num.'" /><label>(Numeric)</label></p>
<p>Bedroom Count    :&emsp;&emsp;&emsp; <input type="text" name="bedroom_count" size="10" maxlength="10" value="'.$bed_count.'" /><label>(Numeric)</label></p>
<p>Bathroom Count   : &emsp;&emsp;&ensp;<input type="text" name="bathroom_count" size="10" maxlength="10" value="'.$bath_count.'" /><label>(Numeric)</label></p>
<p>Total rooms      :&emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" name="room_count" size="10" maxlength="10" value="'.$room_count.'" /><label>(Numeric)</label></p>
